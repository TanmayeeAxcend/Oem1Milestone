    ...
    d.flexslider = function(i, k) {
        ...
        f = {
            ...
            directionNav: {
                setup: function() {
                    var b = d('<ul class="' +
                        e + 'direction-nav"><li><a class="' + e + 'prev" href="#" onclick = "getPrevClicks(' + a.pagingCount + ')"><img src="https://assets2.prnewswire.com/designimages/flex-left-arrow-2.png" alt="" /></a></li><li><a class="' + e + 'next" href="#" onclick = "getNextClicks(' + a.pagingCount + ')"><img src="https://assets2.prnewswire.com/designimages/flex-right-arrow-2.png" alt="" /></a></li></ul>');
                    a.controlsContainer ? (d(a.controlsContainer).ppend(b), a.directionNav = d("." + e + "direction-nav li a", a.controlsContainer)) : (a.append(b), a.directionNav = d("." + e + "direction-nav li a", a));
            ...
            resize: function() {
                !a.animating && a.is(":visible") && (h || a.doMath(), r ? f.smoothHeight() : h ? (a.slides.outerWidth(a.computedW),
                    a.update(a.pagingCount), a.setProps()) : l ? (a.viewport.outerHeight(a.h), a.setProps(a.h, "setTotal")) : (c.smoothHeight && f.smoothHeight(), a.newSlides.outerWidth(a.computedW), a.setProps(a.computedW, "setTotal")))
            },
            smoothHeight: function(b) {
                if (!l || r) {
                    var c = r ? a : a.viewport;
                    b ? c.animate({
                        height: a.slides.eq(a.animatingTo).outerHeight(true)
                    }, b) : c.innerHeight(a.slides.eq(a.animatingTo).innerHeight())
                }
            },
            sync: function(b) {
        ...
        a.flexAnimate = function(b, g, n, i, k) {
            ...
            if (!a.animating && (a.canAdvance(b, k) || n) && a.is(":visible")) {
                ...
                if (r)
                    ...
                    var q = l ? a.slides.filter(":first").innerHeight() : a.computedW;
        ...
        a.doMath = function() {
            ...
            a.w = a.width();
            a.h = b.height();
            a.boxPadding = b.outerWidth(true) - b.width();
